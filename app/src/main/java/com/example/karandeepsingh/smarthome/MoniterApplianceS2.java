...
public class MoniterApplianceS2 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_moniter_appliance_s2);
        ...
        gifImageView = findViewById(R.id.fanGIF);
        imageView = findViewById(R.id.fanImage);
